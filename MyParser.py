INTEGER, PLUS, EOF,FUNC,CHAR,VAR,ASSIGN,WORD,ERROR = 'INTEGER', 'PLUS', 'EOF','FUNC','CHAR','VAR','=','WORD','ERROR'
...
class StatementAdd(object):
    ...
    def __str__(self):
        return 'StatementAdd({var1}, {var2})'.format(
            var1=self.var1,
            var2=self.var2
        )
    ...
    def execute(self):
        ...
        my_print('adding:',var1,'+',var2,'result =',var3,'saved under:'+self.var1)
...
class StatementPrint(object):
    ...
    def __str__(self):
        return 'StatementPrint({var1})'.format(
            var1=self.var1,
        )
...
class StatementInvokeFunction(object):
    ...
    def __str__(self):
        return 'StatementInvokeFunction({var1})'.format(
            var1=self.var1,
        )
